...
class SegmentationMetric:
    ...
    def compute(self):
        ...
        # 新增 F1
        f1_per_class = 2 * precision_per_class * recall_per_class / np.clip(
            precision_per_class + recall_per_class, a_min=1e-12, a_max=None
        )
        ...
        return {
            ...
            "F1": float(np.nanmean(f1_per_class)),   # 新增
        }
