...
from datasets.roads_dataset import CLASS_NAMES, MassachusettsRoadsDataset
...
def main():
    ...
    for p in [runs_root, exp_dir, ckpt_dir, vis_dir, log_dir]:
    ...
    train_ds = MassachusettsRoadsDataset(cfg["data"]["root"], split="train", transform=transforms["train"])
    val_ds = MassachusettsRoadsDataset(cfg["data"]["root"], split="val", transform=transforms["eval"])
